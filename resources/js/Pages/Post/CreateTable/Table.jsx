        ...
        >
            ...
            <div className="py-12">
                ...
                {/*                            </div>*/}
                                    ...
                                    {/*        <fieldset>*/}
                                    {/*            <legend className="text-sm font-semibold leading-6 text-gray-900">By*/}
                                    {/*                Email*/}
                                    {/*            </legend>*/}
                                    ...
                                    {/*                            Comments*/}
                                    {/*                        </label>*/}
                                    {/*                        <p className="text-gray-500">Get notified when someones*/}
                                    ...
                                    {/*                            Candidates*/}
                                    {/*                        </label>*/}
                                    {/*                        <p className="text-gray-500">Get notified when a candidate*/}
                                    {/*                            applies for a job.</p>*/}
                                    {/*                    </div>*/}
                                    {/*                </div>*/}
                                    {/*                <div className="relative flex gap-x-3">*/}
                                    ...
                                    {/*                Notifications*/}
                                    {/*            </legend>*/}
                                    {/*            <p className="mt-1 text-sm leading-6 text-gray-600">These are delivered*/}
                                    {/*                via SMS to your mobile phone.</p>*/}
                                    {/*            <div className="mt-6 space-y-6">*/}
