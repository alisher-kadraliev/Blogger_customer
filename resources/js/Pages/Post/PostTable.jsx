...
const PostTable = ({ posts, statuses, categories }) => {
            ...
            { published: isPublished },
            {
                onSuccess: () => {
                    if (isPublished) {
                        ...
                        toast.success("Yayından alındı!"); // Message for when the post is unpublished
                    }
                },
            },
        );
    ...
    function handleCategoryChange(e, postId) {
        ...
        const categoryId = categories.find(cat => cat.name === newCategory).id
        router.patch(
            `/posts/${postId}/update`,
            { category_id: categoryId },
            {
                onSuccess: () => toast.success("Kategory Değişti"),
                onError: () => "Hata oluştu.",
            },
        );
    }
